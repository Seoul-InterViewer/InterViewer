...
export default function TestTailwind() {
  return (
    <div className="p-8 bg-background">
      <h1 className="text-bold-32 text-main mb-6">Tailwind Test Page</h1>

      {/* Colors */}
      <section className="mb-8">
        <h2 className="text-sb-18 mb-4">Color Tests</h2>
      ...
      {/* Font Sizes */}
      <section className="mb-8">
        <h2 className="text-sb-18 mb-4">Font Size & Weight Tests</h2>

        <h3 className="text-sb-16 mb-2">Bold</h3>
        <p className="text-bold-56 mb-2">Bold 56</p>
        <p className="text-bold-48 mb-2">Bold 48</p>
        <p className="text-bold-40 mb-2">Bold 40</p>
        <p className="text-bold-38 mb-2">Bold 38</p>
        <p className="text-bold-32 mb-2">Bold 32</p>
        <p className="text-bold-18 mb-2">Bold 18</p>
        <p className="text-bold-14 mb-2">Bold 14</p>

        <h3 className="text-sb-16 mb-2 mt-4">Semibold</h3>
        <p className="text-sb-28 mb-2">Semibold 28</p>
        <p className="text-sb-24 mb-2">Semibold 24</p>
        <p className="text-sb-20 mb-2">Semibold 20</p>
        <p className="text-sb-18 mb-2">Semibold 18</p>
        <p className="text-sb-16 mb-2">Semibold 16</p>
        <p className="text-sb-14 mb-2">Semibold 14</p>
        <p className="text-sb-12 mb-2">Semibold 12</p>

        <h3 className="text-sb-16 mb-2 mt-4">Regular</h3>
        <p className="text-regular-24 mb-2">Regular 24</p>
        <p className="text-regular-18 mb-2">Regular 18</p>
        <p className="text-regular-14 mb-2">Regular 14</p>

        <h3 className="text-sb-16 mb-2 mt-4">Medium</h3>
        <p className="text-medium-12 mb-2">Medium 12</p>
        <p className="text-medium-10 mb-2">Medium 10</p>
        <p className="text-medium-8 mb-2">Medium 8</p>
      </section>

      {/* Custom Utilities */}
      <section className="mb-8">
        <h2 className="text-sb-18 mb-4">Utility Classes</h2>
